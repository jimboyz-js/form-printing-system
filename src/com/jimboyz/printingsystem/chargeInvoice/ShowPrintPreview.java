...
public class ShowPrintPreview extends JDialog implements MyInterface{
private static final long serialVersionUID = 1L;
	...
	private void exit() {
		this.addWindowListener(new WindowListener() {
			...
			public void windowClosing(WindowEvent e) {
				frame.setTitle("For Printing System - FPS v. 1.0.0 - Charge Invoice");
			}
	...
	public void loadPrint() {
		...
		try {
			...
			String qty_8 = qty8.getText().toString();
			String qty_9 = qty9.getText().toString();
			String qty_10 = qty10.getText().toString();
			...
			String unit_8 = unit8.getText().toString();
			String unit_9 = unit9.getText().toString();
			String unit_10 = unit10.getText().toString();
			...
			String des_8 = des8.getText().toString();
			String des_9 = des9.getText().toString();
			String des_10 = des10.getText().toString();
			...
			String unitPrice_8 = unitPrice8.getText().toString();
			String unitPrice_9 = unitPrice9.getText().toString();
			String unitPrice_10 = unitPrice10.getText().toString();
			...
			String amount_8 = amount8.getText().toString();
			String amount_9 = amount9.getText().toString();
			String amount_10 = amount10.getText().toString();
			...
			String addVat = txtAddVat.getText().toString();
			...
			hashMap.put("qty8", qty_8);
			hashMap.put("qty9", qty_9);
			hashMap.put("qty10", qty_10);
			...
			hashMap.put("unit8", unit_8);
			hashMap.put("unit9", unit_9);
			hashMap.put("unit10", unit_10);
			...
			hashMap.put("des8", des_8);
			hashMap.put("des9", des_9);
			hashMap.put("des10", des_10);
			...
			hashMap.put("unitPrice8", unitPrice_8);
			hashMap.put("unitPrice9", unitPrice_9);
			hashMap.put("unitPrice10", unitPrice_10);
			...
			hashMap.put("amount8", amount_8);
			hashMap.put("amount9", amount_9);
			hashMap.put("amount10", amount_10);
