package com.jimboyz.printingsystem.chargeInvoice;
...
public class ChargeInvoicePanelGUI extends JPanel implements MyInterface {

	private static final long serialVersionUID = 1L;
	/*
	 * private String prop = "M G. LIG";
	 * private String tin = "122-xxx-xxx-00004"; 
	...
	private JTextField qty8;

	private JTextField unit8;

	private JTextField des8;

	private JTextField unitPrice8;

	private JTextField amount8;

	private JTextField unit9;

	private JTextField des9;

	private JTextField qty9;

	private JTextField unitPrice9;

	private JTextField amount9;

	private JTextField qty10;

	private JTextField unit10;

	private JTextField des10;

	private JTextField unitPrice10;

	private JTextField amount10;
	
	public ChargeInvoicePanelGUI() {
		this.setLayout(null);
		...
		actionMap.put(bindingKey, new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new ShowPrintPreview(txtName, txtAddress, txtTin, txtTerm, txtOsca, txtCh, txtBusiness, qty, qty2, qty3, qty4, qty5, qty6, qty7, qty8, qty9, qty10, unit, unit2, unit3, unit4, unit5, unit6, unit7, unit8, unit9, unit10, des, des2, des3, des4, des5, des6, des7, des8, des9, des10, unitPrice, unitPrice2, unitPrice3, unitPrice4, unitPrice5, unitPrice6, unitPrice7, unitPrice8, unitPrice9, unitPrice10, amount, amount2, amount3, amount4, amount5, amount6, amount7, amount8, amount9, amount10, txtTotalSales, txtVatableSales, txtVatExempt, txtZeroRated, txtVatAmount, txtLessVat, txtAmountNetVat, txtLessDis, txtAddVat, txtTotalAmountDue, txtCust, txtBy, f.format(dateChooser.getDate())).setVisible(true);
			}
			
		});
		
		MainGUI.menuAction(true, true, true, false, new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//frame.setTitle("For Printing System - FPS v. 1.0.0 - Preferences");
		...
		ShowController.clearData1(this, frame, txtName, txtAddress, txtTin, txtTerm, txtOsca, txtCh, txtBusiness, qty, qty2, qty3, qty4, qty5, qty6, qty7, qty8, qty9, qty10, unit, unit2, unit3, unit4, unit5, unit6, unit7, unit8, unit9, unit10, des, des2, des3, des4, des5, des6, des7, des8, des9, des10, unitPrice, unitPrice2, unitPrice3, unitPrice4, unitPrice5, unitPrice6, unitPrice7, unitPrice8, unitPrice9, unitPrice10, amount, amount2, amount3, amount4, amount5, amount6, amount7, amount8, amount9, amount10, txtTotalSales, txtVatableSales, txtVatExempt, txtZeroRated, txtVatAmount, txtLessVat, txtAmountNetVat, txtLessDis, txtAmountNetVat, txtTotalAmountDue, txtCust, txtBy);
	}
	
	public void showBillingStatementPanel() {
		this.setLayout(new BorderLayout());
		this.removeAll();
		this.revalidate();
		this.repaint();
		this.add(new BillingStatementGUI(), BorderLayout.CENTER);
	}
	...
	public void titleHeader() {
		...
		lblTitle = SwingUtil.label(
				"<html><h1 font face=\"Times New Roman\" color=black text-align=\"center\">"+swingUtil.ci_name+"</h1></html>");
		...
		JLabel lblTitle3 = SwingUtil
				.label("<html><h4 font face=\"Times New Roman\"><span <b><i>" + swingUtil.prop + "</i></b></span> <span>- Prop.</span></h4></html>");
		...
		lblTitle4 = SwingUtil.label("<html><h4 font face=\"Times New Roman\">VAT Reg. TIN: " + swingUtil.ci_tin + "</h4></html>");
	...
	public void infoHeader() {
		...
		lblTitle5 = SwingUtil
				.label("<html><h2 font face=\"Times New Roman\" color=black>CHARGE INVOICE</h2></html>");
		...
		Date date = new Date();
		f = new SimpleDateFormat(swingUtil.dateFormatString);
		
		dateChooser = new JDateChooser();
		dateChooser.setBounds(lblDate.getX() + 47, lblDate.getY() + 2, 127, 20);
		dateChooser.setDateFormatString(swingUtil.dateFormatString);
	...
	public void panelBody() {
		...
		JLabel lblName = SwingUtil.label("CHARGED to:", new Font("Times New Roman", Font.PLAIN, swingUtil.FONT_SIZE),
		...
		JLabel lblAddress = SwingUtil.label("Address:", new Font("Times New Roman", Font.PLAIN, swingUtil.FONT_SIZE),
				Color.BLACK, lblName.getX(), lblName.getY() + lblName.getHeight() + 5, 100, 20);
		...
		JLabel lblTerm = SwingUtil.label("Terms:", new Font("Times New Roman", Font.PLAIN, swingUtil.FONT_SIZE),
				Color.BLACK, panelContainer1.getWidth() - 200, lblAddress.getY() + lblAddress.getHeight() + 5, 50, 20);// txtTin.getX()+txtTin.getWidth()+(panelCon.getWidth()-10)
		...
		lblBusiness = SwingUtil.label("Business Style :", new Font("Times New Roman", Font.PLAIN, swingUtil.FONT_SIZE),
				Color.BLACK, lblCh.getX(), lblCh.getY() + lblCh.getHeight() + 5, 150, txtName.getHeight());
	...
	public void tableContainer() {
		...
		panelContainer2.setBounds(5, lblBusiness.getY() + 28, panelBodyContainer.getWidth() - 55, panelBodyContainer.getHeight());
		...
		qty8 = SwingUtil.textField("qty8", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty7.getX(), qty7.getY()+qty7.getHeight(), qty7.getWidth(), qty7.getHeight());
		unit8 = SwingUtil.textField("unit8", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty8.getX()+qty8.getWidth(), qty8.getY(), unit7.getWidth(), unit7.getHeight());
		des8 = SwingUtil.textField("des8", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, des7.getX(), des7.getY()+des7.getHeight(), des7.getWidth(), des7.getHeight());
		unitPrice8 = SwingUtil.textField("unitPrice8", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, unitPrice7.getX(), unitPrice7.getY()+unitPrice7.getHeight(), unitPrice7.getWidth(), unitPrice7.getHeight());
		amount8 = SwingUtil.textField("amount8", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, amount7.getX(), amount7.getY()+amount7.getHeight(), amount7.getWidth(), amount7.getHeight());
		
		qty9 = SwingUtil.textField("qty9", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty8.getX(), qty8.getY()+qty8.getHeight(), qty8.getWidth(), qty8.getHeight());
		unit9 = SwingUtil.textField("unit9", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty9.getX()+qty9.getWidth(), qty9.getY(), unit8.getWidth(), unit8.getHeight());
		des9 = SwingUtil.textField("des9", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, des8.getX(), des8.getY()+des8.getHeight(), des8.getWidth(), des8.getHeight());
		unitPrice9 = SwingUtil.textField("unitPrice9", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, unitPrice8.getX(), unitPrice8.getY()+unitPrice8.getHeight(), unitPrice8.getWidth(), unitPrice8.getHeight());
		amount9 = SwingUtil.textField("amount9", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, amount8.getX(), amount8.getY()+amount8.getHeight(), amount8.getWidth(), amount8.getHeight());
		
		qty10 = SwingUtil.textField("qty10", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty9.getX(), qty9.getY()+qty9.getHeight(), qty9.getWidth(), qty9.getHeight());
		unit10 = SwingUtil.textField("unit10", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty10.getX()+qty10.getWidth(), qty10.getY(), unit9.getWidth(), unit9.getHeight());
		des10 = SwingUtil.textField("des10", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, des9.getX(), des9.getY()+des9.getHeight(), des9.getWidth(), des9.getHeight());
		unitPrice10 = SwingUtil.textField("unitPrice10", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, unitPrice9.getX(), unitPrice9.getY()+unitPrice9.getHeight(), unitPrice9.getWidth(), unitPrice9.getHeight());
		amount10 = SwingUtil.textField("amount10", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, amount9.getX(), amount9.getY()+amount9.getHeight(), amount9.getWidth(), amount9.getHeight());
		
		JLabel lblTotalSales = SwingUtil.label("Total Sales (VAT Inclusive) :", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, qty10.getX(), qty10.getY()+qty10.getHeight()+5, 190, 23);
		txtTotalSales = SwingUtil.textField("totalSales", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, lblTotalSales.getX()+lblTotalSales.getWidth()+3, lblTotalSales.getY(), 150, qty10.getHeight());
		
		JLabel lblLessVat = SwingUtil.label("Less:12% VAT:", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, txtTotalSales.getX()+txtTotalSales.getWidth()+3, txtTotalSales.getY(), 160, 23);
		lblLessVat.setToolTipText("Less: 12% VAT");
		...
		JLabel lblTotalAmountDue = SwingUtil.label("Total Amount Due:", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, txtZeroRated.getX()+txtZeroRated.getWidth()+3, txtZeroRated.getY(), lblLessVat.getWidth(), 23);
		...
		txtVatAmount = SwingUtil.textField("vatAmount", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, lblVatAmount.getX()+lblVatAmount.getWidth()+3, lblVatAmount.getY(), lblTotalAmountDue.getX()-s, qty7.getHeight());
		
		JLabel lblAddVat = SwingUtil.label("Add: VAT:", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, txtVatAmount.getX()+txtVatAmount.getWidth()+3, txtVatAmount.getY(), lblLessVat.getWidth(), 23);
		lblAddVat.setToolTipText("Add: VAT");
		txtAddVat = SwingUtil.textField("addVat", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, lblAddVat.getX()+lblAddVat.getWidth()+3, lblAddVat.getY(), txtLessVat.getWidth(), qty7.getHeight());
		
		JLabel lblCust = SwingUtil.label("Authorized Rep. :", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, panelContainer2.getX(), panelContainer2.getY()+panelContainer2.getHeight()+7, lblVatableSales.getWidth(), 23);
		txtCust = SwingUtil.textField("customerName", SwingUtil.myFont(swingUtil.FONT, swingUtil.FONT_STYLE, swingUtil.FONT_SIZE), Color.BLACK, lblCust.getX()+lblCust.getWidth()+3, lblCust.getY(), lblTotalAmountDue.getX()-s, qty7.getHeight());
		txtCust.setText(SetPreferences.getProperietor());
		...
		panelContainer2.add(qty8);
		panelContainer2.add(unit8);
		panelContainer2.add(des8);
		panelContainer2.add(unitPrice8);
		panelContainer2.add(amount8);
		
		panelContainer2.add(qty9);
		panelContainer2.add(unit9);
		panelContainer2.add(des9);
		panelContainer2.add(unitPrice9);
		panelContainer2.add(amount9);
		
		panelContainer2.add(qty10);
		panelContainer2.add(unit10);
		panelContainer2.add(des10);
		panelContainer2.add(unitPrice10);
		panelContainer2.add(amount10);
		...
		panelContainer2.add(lblAddVat);
		panelContainer2.add(txtAddVat);
	...
	private void scrollBarFunctionable() {
		AdjustmentListener adj = new AdjustmentListener() {
			...
			public void adjustmentValueChanged(AdjustmentEvent e) {
				int changeValue = e.getValue()+e.getValue()+e.getValue()+e.getValue();
				int y = 3;
				if(e.getValue() == 0) {
					panelCon2.setBounds(3, 3, panelContainer1.getWidth() - 6, panelContainer1.getHeight()-6);
				}else {
